        ...
        <header className={`${styles.AppHeader} m-5 p-2`}>
            <div className={appStyles.row}>
                ...
                <Link className={`mr-2 p-2 ${styles.link} ${appStyles.row}`} to='/feed'>
                    ...
                    <p className={'text text_type_main-default ml-1' + (location.pathname !== '/feed' ? " text_color_inactive" : "")}>Лента
                        заказов</p>
                </Link>
            </div>
            ...
            <Link className={`mr-2 p-2 ${styles.link} ${appStyles.row}`} to={'/profile'}>
                ...
                <p className={'text text_type_main-default ml-1' + (location.pathname !== '/profile' ? " text_color_inactive" : "")}>Личный
                    кабинет</p>
            </Link>
        </header>
    )
